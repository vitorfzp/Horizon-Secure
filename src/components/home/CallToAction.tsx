      ...
      <div className="relative z-10 container mx-auto flex flex-col items-center px-6 text-center">
        ...
        <Reveal delay={400} direction="up">
          <Link href="/contato" className="group">
            <button className="btn-glitch flex transform items-center gap-2 rounded-full bg-white px-10 py-4 font-mono font-bold tracking-wider text-black uppercase shadow-lg transition-all group-hover:scale-105">
