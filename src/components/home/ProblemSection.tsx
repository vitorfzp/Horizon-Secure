...
export function ProblemSection() {
  const problems = [
    ...
    { icon: EyeOff, title: "Dados Invisíveis", desc: "Seus dados de clientes e informações financeiras estão realmente seguros ou expostos sem você saber?", color: "purple" },
    { icon: AlertTriangle, title: "Custo do Erro", desc: "Uma pequena falha de configuração pode acabar custando caro para a reputação e o caixa da empresa.", color: "red" }
  ];
