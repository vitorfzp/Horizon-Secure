...
// --- MOBILE (CORRIGIDO: Cores dos binários ajustadas) ---
const MobileServiceCard = ({ service, onOpen }: ServiceCardProps) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Fundo decorativo "Tech" - CORRIGIDO AQUI */}
        {/* Usamos text-{color}-400 para garantir a cor vibrante e aumentamos a opacity para 20 */}
